...
public sealed class InputOptions
{
    ...
    public InputBinding ToggleGameView = new(KeyboardKeys.G);

    [DefaultValue(typeof(InputBinding), "P")]
    [EditorDisplay("Viewport"), EditorOrder(1770)]
    public InputBinding ToggleNavMeshVisibility = new(KeyboardKeys.P);
    ...
    public InputBinding Particles = new(KeyboardKeys.None);
