...
namespace FlaxEditor.CustomEditors.Editors
{
    ...
    public static class ActorTransformEditor
    {
        ...
        /// The X axis color.
        /// </summary>
        public static Color AxisColorX = new(1.0f, 0.0f, 0.02745f, 1.0f);

        /// <summary>
        /// The Y axis color.
        /// </summary>
        public static Color AxisColorY = new(0.239215f, 1.0f, 0.047058f, 1.0f);

        /// <summary>
        /// The Z axis color.
        /// </summary>
        public static Color AxisColorZ = new(0.0f, 0.0235294f, 1.0f, 1.0f);
