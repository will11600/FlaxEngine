        ...
        public override void DrawSelf()
        {
            ...
            if (HasSelection && IsFocused)
            {
                ...
                if (selectedLinesCount == 1)
                {
                    ...
                    Rectangle r1 = new(leftEdge.X, leftEdge.Y, rightEdge.X - leftEdge.X, fontHeight);
                ...
                else
                {
                    ...
                    Rectangle r1 = new(leftEdge.X, leftEdge.Y, 1000000000, fontHeight);
                    Render2D.FillRectangle(r1, selectionColor);
                    //
                    for (int i = 3; i <= selectedLinesCount; i++)
                    {
                        leftEdge.Y += textHeight;
                        Rectangle r = new(leftMargin, leftEdge.Y, 1000000000, fontHeight);
                        Render2D.FillRectangle(r, selectionColor);
                    }
                    //
                    Rectangle r2 = new(leftMargin, rightEdge.Y, rightEdge.X - leftMargin, fontHeight);
